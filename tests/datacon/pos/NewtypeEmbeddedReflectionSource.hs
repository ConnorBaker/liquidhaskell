...
-- The producer intentionally lacks a global reflection option, matching an
-- imported embedded type whose consumer enables reflection.
module NewtypeEmbeddedReflectionSource (Support, wrap, unwrap, unionSupport, unionIdempotent, forceUnion) where
